...
def run_test():
    ...
    try:
        ...
        pyautogui.press('o')
        time.sleep(0.600)
        print(f"Check #2: Performing manual visual check: First Custom Check")
        verify_window_screenshot(os.path.join(os.path.dirname(__file__), 'screenshots\\check_19.png'), check_name='First Custom Check', check_index=2)
        print("Check #2: Visual check completed")
        
        # ====================
        # Testing mouse drag operation
        # ====================
        ...
        pyautogui.mouseUp()
        time.sleep(0.400)
        print(f"Check #4: Performing manual visual check: Second Custom Check")
        verify_window_screenshot(os.path.join(os.path.dirname(__file__), 'screenshots\\check_25.png'), check_name='Second Custom Check', check_index=4)
        print("Check #4: Visual check completed")
